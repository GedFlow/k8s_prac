...
<h1 align='center'><b>쿠버네티스 부수기</b></h1>

## **1. 프로젝트 소개**

![Project Poster]()

> 는 실시간으로 게임 참여자를 모집하며, 다양한 유저들과 소통할 수 있는 공간입니다.<br/>
> 를 통해 진정한 BUDDY를 만나보세요!

☸️[Helm 배포 URL](https://artifacthub.io/packages/helm/ptj-miniproject/flaskdiary)🎮
...
<b>프로젝트 진행 기간 : 2025년 06월 30일 ~ 2025년 07월 04일</b>

|          **Day**          | **Do**                                                                                                                                                   |
| :------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------- 
| 06/30 | - 프로젝트 시작 및 요구사항 분석, 도커 이미지 제작에 대해 개인 학습 
| 07/01 | - Python(Flask)를 활용한 간단한 일기서비스 개발 및 도커 이미지로 제작                                                                                                                  
| 07/02 | - 제작한 이미지를 활용하여 쿠버네티스 시스템 구축 (Ingree - flask - Db)              
| 07/03 | - Helm 차트로 패키징, Artifact Hub에 업로드                                            
| 07/04 | - 보고서 작성                                                                
...
├── README.md ―――――――――――――
├── 📂 charts ―――――――――――――
├── flaskDiary-1.2.1.tgz ―― helm으로 패키징한 차트 패키지
├── index.yaml ―――――――――――― helm 저장소 인덱스
├── 📂 templates ―――――――――― yaml파일을 모아둔 폴더
│   ├── configmap.yml ――――― configmap 파일
│   ├── db-deploy.yml ――――― 데이터베이스 Deployment. 레플리카셋은 1이라 실제로 생성되는 파드는 한 개
│   ├── hpa.yml ――――――――――― 오토스케일링을 위한 HPA
│   ├── ing.yml ――――――――――― Ingress, ingress관련 애드온을 활성화 해야한다.
│   ├── job.yml ――――――――――― Job, web서버와 DB서버의 연동을 위해 처음 기동시 한 번 실행한다.
│   ├── pv-hp.yml ――――――――― HostPath방식의 PV. DB를 여러대 만드는 경우 사용할 수 없다.
│   ├── pv-nfs.yml ―――――――― NFS 방식의 PV. NFS 서버 설정이 필요하다.
│   ├── pvc-hp.yml ―――――――― pv-hp를 사용하는 PVC (기본값)
│   ├── pvc-nfs.yml ――――――― pv-nfs를 사용하는 PVC
│   ├── secret.yml ―――――――― 시크릿 파일이다.
│   ├── svc.yml ――――――――――― 서비스.
│   ├── tls-secret.yml ―――― ingress TLS-Termination 구현을 위한 yaml
│   └── web-deploy.yml ―――― 웹 서버 Deployment. 2개 생성.
└── values.yaml ――――――――――― helm 차트 기본 설정값
```
